...
angular.module('myApp', ['ngRoute', 'myApp.controllers', 'myApp.filters', 'myApp.services', 'myApp.directives', 'textAngular', 'ui.bootstrap']).config(function($routeProvider, $locationProvider) {
