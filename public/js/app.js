...
angular.module('myApp', ['ngRoute', 'myApp.controllers', 'myApp.filters', 'myApp.services', 'myApp.directives', 'textAngular']).config(function($routeProvider, $locationProvider) {
